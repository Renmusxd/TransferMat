...
pub fn make_d2s(d1s: &[usize]) -> Vec<usize> {
    let d1 = |n: usize| {
        if n >= d1s.len() {
            0
        } else {
...
#[pyfunction]
pub fn generate_d2s(d1s: Vec<usize>) -> Vec<usize> {
    make_d2s(&d1s)
}
...
#[pyfunction]
pub fn get_n_uniform_states(l: usize, k: u8, d1s: Vec<usize>) -> usize {
    let d2s = make_d2s(&d1s);
...
pub fn get_norm_squared<It, Itt>(ngs: It, d2s: &[usize]) -> usize
where
...
#[pyfunction]
pub fn generate_uniform_states(
    py: Python,
    l: usize,
    k: u8,
    d1s: Vec<usize>,
...
pub fn get_n_sector<It, Arr>(ngs: It, k: u8) -> Vec<usize>
where
...
pub fn cycles_for_perm(perm: &[usize]) -> Vec<Vec<usize>> {
...
#[pyfunction]
pub fn gen_self_overlap_matrix(
    py: Python,
    l: usize,
    k: u8,
    d1s: Vec<usize>,
...
#[pyfunction]
pub fn gen_cycles_for_perm(perm: Vec<usize>) -> Vec<Vec<usize>> {
    cycles_for_perm(&perm)
}

#[pyfunction]
pub fn make_cycles_mat(k: u8) -> Vec<Vec<Vec<Vec<usize>>>> {
...
pub fn make_ortho_overlap_matrix_raw(
    l: usize,
    k: u8,
    d1s: Vec<usize>,
    n_sector: Option<Vec<usize>>,
...
pub fn make_overlap_matrix_raw(
    l: usize,
    k: u8,
    d1s: Vec<usize>,
...
pub fn make_uniform_perm_overlap_matrix_raw(
    l: usize,
    k: u8,
    d1s: Vec<usize>,
    n_sector: Option<Vec<usize>>,
...
#[pyfunction]
pub fn make_ortho_overlap_matrix(
    py: Python,
    l: usize,
    k: u8,
    d1s: Vec<usize>,
...
pub fn nopy_make_overlap_matrix(
    l: usize,
    k: u8,
    d1s: Vec<usize>,
    n_sector: Option<Vec<usize>>,
...
#[pyfunction]
pub fn make_uniform_perm_overlap_matrix(
    py: Python,
    l: usize,
    k: u8,
    d1s: Vec<usize>,
